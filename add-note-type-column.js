...
console.log('🔧 Agregando columna noteType a la tabla notas...');
...
connection.connect((err) => {
    ...
    // Agregar columna noteType
    const addColumnSQL = `
        ALTER TABLE innovacel_db.notas 
        ADD COLUMN noteType VARCHAR(50) DEFAULT 'consulta'
    `;
    ...
    connection.query(addColumnSQL, (err) => {
        if (err) {
            ...
            console.log('✅ Columna noteType agregada exitosamente');
